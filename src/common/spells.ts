...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.set(Network.BASE, new Map<string, Address>());

// eUSD
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.MAINNET).set(
  Address.fromString(
    "0x7BEa807798313fE8F557780dBD6b829c1E3aD560"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.MAINNET).set(
  Address.fromString(
    "0x5d8A7DC9405F08F14541BA918c1Bf7eb2dACE556"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.MAINNET).set(
  Address.fromString(
    "0x788Fd297B4d497e44e4BF25d642fbecA3018B5d2"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.MAINNET).set(
  Address.fromString(
    "0x9D769914eD962C4E609C8d7e4965940799C2D6C0"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.MAINNET).set(
  Address.fromString(
    "0x12e4F043c6464984A45173E0444105058b6C3c7B"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.MAINNET).set(
  Address.fromString(
    "0xf33b8F2284BCa1B1A78142aE609F2a3Ad30358f3"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.BASE).set(
  Address.fromString(
    "0x4284D76a03F9B398FF7aEc58C9dEc94b289070CF"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.BASE).set(
  Address.fromString(
    "0x520CF948147C3DF196B8a21cd3687e7f17555032"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.BASE).set(
  Address.fromString(
    "0x48f4EA2c10E6665A7B77Ad6B9BD928b21CBe176F"
  ).toHexString(),
...
SPELL_3_4_0_TIMELOCK_GOVERNANCE.get(Network.BASE).set(
  Address.fromString(
    "0x88CF647f1CE5a83E699157b9D84b5a39266F010D"
  ).toHexString(),
